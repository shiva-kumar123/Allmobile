package allMobiles;
	...
	public class order extends launcher
	{
	@Test(priority = 2)
	...
	driver.findElement(By.id("inputFirstName")).sendKeys("shiva");
	driver.findElement(By.xpath("(//*[@id='inputFirstName'])[2]")).sendKeys("kumar");
	driver.findElement(By.id("inputEmail")).sendKeys("Shivakumar1997@gmail.com");
	driver.findElement(By.id("inputPassword")).sendKeys("Shiva@123");
	driver.findElement(By.id("flexRadioDefault2")).click();
	driver.findElement(By.xpath("//*[@placeholder='00000000000']")).sendKeys("12345678");
	driver.findElement(By.id(" address1")).sendKeys("No 3rd cross");
	driver.findElement(By.id("address2")).sendKeys("nandini layout");
	...
	driver.findElement(By.id("inputZip")).sendKeys("560096");
